        ...
        <div className="wrapper">
          ...
          <div className="project">
            ...
            <div className="right">
              ...
              <h3>Technologies used :</h3>
              <div>
                <FaHtml5 size="1.75rem" style={{margin:".5rem .2rem" , color:"F25320"}}/>
                <FaCss3Alt size="1.75rem" style={{margin:".5rem .2rem" , color:"279FD5"}}/>
                <FaJs size="1.75rem" style={{margin:".5rem .2rem" , color:"E4D04B"}}/>
                <FaSass size="1.75rem" style={{margin:".5rem .2rem" , color:"CF649A"}}/>
                <FaReact size="1.75rem" style={{margin:".5rem .2rem" , color:"5CCFEE"}}/>
                <FaNodeJs size="1.75rem" style={{margin:".5rem .2rem" , color:"4F9640"}}/>
                <SiMongodb size="1.75rem" style={{margin:".5rem .2rem" , color:"449E45"}}/>
                <SiRedux size="1.75rem" style={{margin:".5rem .2rem" , color:"7248B6"}}/>
              </div>
            </div>
          </div>
